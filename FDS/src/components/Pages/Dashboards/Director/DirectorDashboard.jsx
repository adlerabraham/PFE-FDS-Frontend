...
import CoordinatorDashboardBar from '../Coordinator/CoordinatorDashboardBar.jsx';

function DirectorDashboard(props) {
                    ...
                    <div className="nav-top">
                        <div className='nav-box'>
                            <div className='nav-option'>
                                ...
                                {isSidebarOpen && <NavLink to="/directorDashboard" className='nav-link'>Accueil</NavLink>}
                            </div>
                            <div className='nav-option'>
                                <CalendarOutlined className='nav-icon' />
                                {isSidebarOpen && <NavLink to="/directorDashboard/directorCalendar" className='nav-link'>Calendrier</NavLink>}
                            </div>
                        </div>
                    </div>
                    <div className="nav-middle">
                        {/* <div className='nav-box'>
                            <div className="nav-option">
                                ...
                                {isSidebarOpen && <NavLink to="/directorDashboard/orderStat" className='nav-link'>Commande de documents</NavLink>}
                            </div>
                            <div className="nav-option">
                                <BookOutlined className='nav-icon' />
                                {isSidebarOpen && <NavLink to="" className='nav-link'>Gestion des examens</NavLink>}
                            </div>
                            <div className="nav-option">
                                <BookOutlined className='nav-icon' />
                                {isSidebarOpen && <NavLink to="" className='nav-link'>Gestion des calendriers</NavLink>}
                            </div>
