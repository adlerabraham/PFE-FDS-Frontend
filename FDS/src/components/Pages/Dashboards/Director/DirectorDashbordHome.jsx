...
function DirectorDashbordHome() {
    ...
    if (!(isLoading || isError)) {
        ...
        for (let index = 0; index < orderStat.length; index++) {
            ...
            //Set name filters
            const nameFilterIndex = columns[0].filters.findIndex((filter) =>
            ...
            //set class filters
            const classFilterIndex = columns[1].filters.findIndex((filter) =>
            ...
            const documentFilterIndex = columns[2].filters.findIndex((filter) =>
                filter.text === order.document_name
            )
            if (documentFilterIndex == -1) {
                columns[2].filters.push({
            ...
            //Set date filters
            const dateFilterIndex = columns[3].filters.findIndex((filter) =>
                filter.text === date
            )
            ...
            //Set Acayear filters
            const acaYearFilterIndex = columns[5].filters.findIndex((filter) =>
